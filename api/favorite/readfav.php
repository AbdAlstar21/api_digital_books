...
if (
	...
	if(trim($txtsearch) != "")
	{
		$sql = "select books.* , fav_id from books inner join favorite on 
		books.book_id = favorite.book_id where user_id = $user_id  and book_name like ? 
	...
	{
		$sql = "select books.* , fav_id from books inner join favorite on 
		books.book_id = favorite.book_id 
